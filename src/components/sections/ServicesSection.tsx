...
const services = [
  {
    ...
    description:
      "Полная настройка системы складского учета для вашего бизнеса. От первичной настройки до обучения сотрудников.",
    features: [
  ...
  },
  {
    ...
    description:
      "Настройка CRM-системы для автоматизации продаж. Воронки, аналитика, интеграции с мессенджерами.",
    features: [
      "Настройка воронки продаж",
      "Интеграция с телефонией (IP-АТС)",
      "Подключение WhatsApp, Telegram",
  ...
  },
  {
    ...
    description:
      "Подключение вашего бизнеса к ведущим маркетплейсам Казахстана и России. Единое управление из одного окна.",
    features: [
      "Kaspi Магазин — полная интеграция",
      "Wildberries — управление поставками",
      "Ozon — синхронизация каталога",
    ...
    <section className="section-padding bg-white" id="services">
      <div className="container-custom">
        <SectionHeading
          badge="Услуги"
          title="Что мы делаем"
          description="Комплексная автоматизация бизнеса от анализа до внедрения и поддержки"
        />
            ...
            return (
              ...
              >
                  ...
                  <ul className="space-y-3 mb-8">
                    {service.features.map((feature) => (
                      <li key={feature} className="flex items-start gap-3">
                        <CheckCircle2
                          className={`w-5 h-5 ${colors.checkColor} flex-shrink-0 mt-0.5`}
                        />
                ...
                <div className={isReversed ? "lg:order-1" : ""}>
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 aspect-[4/3] flex items-center justify-center">
