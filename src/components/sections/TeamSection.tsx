    ...
    <section className="section-padding bg-gray-50" id="team">
      <div className="container-custom">
        <SectionHeading
          ...
          description="Сертифицированные эксперты с опытом работы в крупных проектах"
        />
          ...
          {team.map((member, index) => (
            ...
            >
              <div className="relative mb-4 mx-auto w-28 h-28 md:w-32 md:h-32">
                <div
                  className={`w-full h-full ${member.color} rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-lg`}
                >
